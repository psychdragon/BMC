...
$systemPromptTemplate = file_get_contents('system_prompt_roadmap.md');
...
// ... (cURL options as in other generate scripts)
...
if (file_put_contents($roadmapFilePath, json_encode($decodedContent, JSON_PRETTY_PRINT))) {
    echo json_encode(['status' => 'success', 'message' => 'Project roadmap generated successfully!', 'file' => $roadmapFile]);
} else {
    http_response_code(500);
    echo json_encode(['status' => 'error', 'message' => 'Failed to save the generated roadmap file.']);
}
